...
get_filename_component(_filename "/home/colander/projects/ROS_todoList_chatbot/cogrob_ws/src/rasa_ros/srv/Dialogue.srv" NAME_WE)
add_custom_target(_rasa_ros_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rasa_ros" "/home/colander/projects/ROS_todoList_chatbot/cogrob_ws/src/rasa_ros/srv/Dialogue.srv" ""
)
...
_generate_srv_cpp(rasa_ros
  "/home/colander/projects/ROS_todoList_chatbot/cogrob_ws/src/rasa_ros/srv/Dialogue.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rasa_ros)
  install(CODE "execute_process(COMMAND \"/home/colander/virtual_environments/CognitiveRobotics/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rasa_ros\")")
  # install generated code
  install(
