...
def handle_service(req):
    ...
    if input_text.data == " ":
        ...
        save_object("/home/luigi/ROS_todoList_chatbot/cogrob_ws/src/rasa_ros/scripts/audio.pkl", X)
        save_object("/home/luigi/ROS_todoList_chatbot/cogrob_ws/src/rasa_ros/scripts/name.pkl", Y)
    return response
